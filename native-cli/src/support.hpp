...
inline constexpr const char* host_name = "com.ai_hider.editlens";
inline constexpr const char* policy_id = "gradient-q4-composite-v1-retrospective";
inline constexpr double flag_threshold = 0.9824231167326641;
